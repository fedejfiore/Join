    ...
    <section id="contacto" className="section-dynamic">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-8">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#5D9CEC] mb-3">Contacto</p>
...
function InfoBox({ icon: Icon, label, value }) {
  return (
    <div className="flex items-center gap-4 p-5 rounded-xl"
      style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderLeft: '3px solid #5D9CEC' }}>
      <div style={{ color: '#5D9CEC' }}><Icon size={20} /></div>
      <div>
