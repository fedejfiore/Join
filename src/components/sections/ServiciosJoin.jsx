                  ...
                  >
                    <div className="relative h-[420px] rounded-xl overflow-hidden shadow-2xl group"
                      ...
                      <div className="absolute bottom-0 left-0 text-white z-[10] w-full text-center"
                        ...
                        <SheetText as="h3" text={s.Titulo} className="font-bold mb-3" style={{ fontSize: '1.2rem', lineHeight: 1.3, color: '#ffffff' }} />
                        <SheetText as="p" text={s.Detalle || s.Descripcion} className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.72)', maxWidth: '280px', margin: '0 auto' }} />
                      </div>
                    </div>
                  </a>
                </SwiperSlide>
