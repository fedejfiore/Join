...
export async function middleware(request) {
  ...
  try {
    ...
    if (found) {
      // TODO: reemplazar con el Apps Script de JOIN para tracking de QR
      ...
      if (isExternal) {
        try {
          const urlObj = new URL(destinoRaw);
          urlObj.searchParams.set('utm_source', 'qr_join');
          urlObj.searchParams.set('utm_medium', 'offline');
          urlObj.searchParams.set('utm_campaign', campaña);
